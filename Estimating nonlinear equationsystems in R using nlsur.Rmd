...
summary(res2)
```
```{r print_modelcomp, cache=TRUE, echo=FALSE}
...
```{r print_modelcomp2, cache=TRUE, echo=FALSE}
...
```{r compare_systems, cache=TRUE, echo=FALSE}
